...
\begin{thebibliography}{数字}
  \bibitem{Verbeek Bruno Christopher 2020} Verbeek, Bruno and Christopher Morris, "Game Theory and Ethics", The Stanford Encyclopedia of Philosophy (Winter 2020 Edition), Edward N. Zalta (ed.), URL = <https://plato.stanford.edu/archives/win2020/entries/game-ethics/>.
  \bibitem{GSMA 2020} GSMA. 2020. The Mobile Economy 2020
  \bibitem{Google} https://google.com
  \bibitem{Facebook}
  \bibitem{Nakamoto 2008} Satoshi Nakamoto. Bitcoin: A peer-to-peer electronic cash system. https://bitcoin.org/bitcoin.pdf, 2008.
