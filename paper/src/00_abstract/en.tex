...
% 筆者は、社会契約の概念をインターネットに適用することがこの問題の解決に繋がると考え、
...
% 論文の趣旨
% ここで筆者は、強制執行力を自己組織化させる成員の振る舞いがビザンチン将軍問題の署名付きの解法\cite{lamport1982}によって説明でき、
...
% 結果(先行研究との比較を含める)
% そのために筆者はゲーム理論とビザンチン将軍問題の解法を用いて社会契約を成員の振る舞いによる複雑系としてモデリングし、
